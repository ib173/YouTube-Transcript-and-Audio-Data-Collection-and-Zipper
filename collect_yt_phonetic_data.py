...
""" current example case: collecting inebriated and sober audio data """

save_path = """ file path for saving original audio files """
chunk_save_path =  """ file path for saving chunked audio files """
